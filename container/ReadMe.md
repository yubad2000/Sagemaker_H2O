...
This example shows how to package an algorithm for use with SageMaker. In additon to [scikit-learn][skl], we also integrate H2O for model training and deployment.
...
* __im-server__: The directory that contains the application to run in the container. See the next session for details about each of the files.
